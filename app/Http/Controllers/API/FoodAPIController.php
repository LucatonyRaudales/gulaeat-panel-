...
//            $this->foodRepository->orderBy('area');
            $foods = $this->foodRepository->where('status', 1)->get();
    ...
    public function verifyPendings(){
        try {

            $foods = Food::where('status', 0)->get()->count();

            return $this->sendResponse($foods, __('lang.updated_successfully', ['operator' => __('lang.food')]));
