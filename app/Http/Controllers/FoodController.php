...
class FoodController extends Controller
{
    ...
    public function create()
    {
        ...
        $statuses = \DB::table('food_statuses')->pluck('name', 'id');
        ...
        return view('foods.create')->with("customFields", isset($html) ? $html : false)->with("restaurant", $restaurant)
            ->with("category", $category)->with('statuses', $statuses);
    }
    ...
    public function show($id)
    {
        ...
        return view('foods.show')->with('food', $food)->with('statuses', $statuses);
    }
    ...
    public function edit($id)
    {
        ...
        return view('foods.edit')->with('food', $food)->with("customFields", isset($html) ? $html : false)
            ->with("restaurant", $restaurant)->with("category", $category)->with('statuses', $statuses);
    }
