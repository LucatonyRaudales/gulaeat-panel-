...
class UsersTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \DB::table('users')->insert(array (
            ...
            /** Usuario agregado para solicitar la ubicacion dentro del panel de ordenes, no tocar*/
                array (
                    'id' => 7,
                    'name' => 'Drivers',
                    'email' => 'drivers@request.com',
                    'password' => '$2y$10$9op8X90KvQRtXRFD6trSKuBVmO3l/I1Lv9vF1il4CTq72rTfdbFcC',
                    'api_token' => 'qXaWaoe6S09TYg1VblsL2cgbmCdhSpH4pzxY5ZjRDTj68G8l5fJ29N4kBHnY',
                    'remember_token' => '',
                    'created_at' => '2021-01-29 16:00:00',
                    'updated_at' => '2021-01-29 16:00:00',
                    'braintree_id' => NULL,
                    'paypal_email' => NULL,
                    'stripe_id' => NULL,
                    'card_brand' => NULL,
