...
|
*/
/* temporal -> */ Route::put('driver/location/{driver}', 'API\DriverAPIController@location')->name('drivers.location');
/* temporal -> */ Route::get('driver/locate/{driver}', 'API\DriverAPIController@locate')->name('drivers.locate');
/* temporal -> */ Route::resource('/drivers', 'API\DriverAPIController');

Route::post('/location/{order}', 'API\DriverAPIController@changedLocation')->name('location');
Route::get('orders/updateAllArrives/{order_id?}', 'API\OrderAPIController@updateAllArrives');
...
Route::prefix('driver')->group(function () {
    ...
    Route::get('listInactive', 'API\Driver\UserAPIController@listInactive');
});
...
Route::get('getUser/{id}', 'API\UserAPIController@getUser');
...
Route::get('food/verifyPendings', 'API\FoodAPIController@verifyPendings');
Route::resource('restaurants', 'API\RestaurantAPIController');
Route::get('ordersJoinDriver/{id}', 'API\OrderAPIController@joinDriver');
...
Route::middleware('auth:api')->group(function () {
    Route::group(['middleware' => ['role:driver']], function () {
        Route::prefix('driver')->group(function () {
            ...
            //Route::put('drivers/{id}', 'API\DriverAPIController@update');
            Route::resource('faq_categories', 'API\FaqCategoryAPIController');
            Route::resource('faqs', 'API\FaqAPIController');
            //Route::get('locate/{driver}', 'API\DriverAPIController@locate');
            //Route::put('location/{driver}', 'API\DriverAPIController@location');
        });
    });
    ...
    Route::get('delivery_addresses/all', 'API\DeliveryAddressAPIController@all');
    ...
    Route::get('dashboard/drivers', 'API\DashboardAPIController@drivers');
});